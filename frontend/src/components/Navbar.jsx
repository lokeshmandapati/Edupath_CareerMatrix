...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-borderline bg-page/70 shadow-soft backdrop-blur-md">
      <div className="mx-auto grid max-w-6xl grid-cols-3 items-center gap-4 px-4 py-3 sm:px-6">
            ...
            <nav className="hidden items-center gap-1 md:flex">
              {[
                ...
                <Link
                  key={path}
                  to={path}
                  className="flex items-center gap-2 whitespace-nowrap rounded-xl px-2.5 py-2 text-[13px] font-bold text-muted transition-all duration-300 hover:bg-primary/10 hover:text-primary active:scale-95"
                >
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl bg-surface shadow-soft ring-1 ring-borderline transition-all hover:scale-110 hover:bg-page hover:shadow-glow"
          ...
          >
            {theme === 'dark' ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" /></svg>
            )}
          </button>
          ...
          {isAuthenticated && (
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                className="hidden items-center gap-2 rounded-xl bg-red-500/10 px-4 py-2 text-sm font-bold text-red-600 transition-all hover:bg-red-500 hover:text-white shadow-sm sm:flex"
              >
                <span>Logout</span>
